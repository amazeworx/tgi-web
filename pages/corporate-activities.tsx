        ...
        <section id="gcg" className="py-24 scroll-mt-24 bg-slate-100">
          <div className="container px-8 max-w-screen-xl mx-auto">
            ...
            <div className="flex gap-x-8 mt-24 mb-8 justify-center">
              <div className="w-1/2 bg-white rounded-2xl border-t-2 border-r-2 border-b-8 border-l-2 border-tgi-amber p-8">
                <div className="flex gap-x-6">
                  <div className="w-1/4">
                    <a href="#" className="block">
                      <Image
                        className="rounded-lg border"
                        src="/static/images/coc.jpg"
                        alt=""
                        width={600}
                        height={849}
                        priority
                  ...
                  <div className="w-3/4">
                    <h5 className="text-2xl text-tgi-green font-bold mt-3 mb-4">
                      Pedoman Perilaku / Code of Conduct (CoC)
                    </h5>
                    <div>
                      <a
                        href="#"
                        className="inline-flex px-4 py-2 rounded-lg bg-tgi-green text-white gap-x-3 text-sm uppercase no-underline font-medium items-center transition duration-200 shadow-md hover:shadow-lg"
                      >
                ...
                <div className="flex gap-x-6">
                  <div className="w-1/4">
                    <a href="#" className="block">
                      <Image
                        className="rounded-lg border"
                        src="/static/images/board-manual.jpg"
                        alt=""
                        width={600}
                        height={849}
                        priority
                  ...
                  <div className="w-3/4">
                    <h5 className="text-2xl text-tgi-green font-bold mt-3 mb-4">Board Manual</h5>
                    <div>
                      <a
                        href="#"
                        className="inline-flex px-4 py-2 rounded-lg bg-tgi-green text-white gap-x-3 text-sm uppercase no-underline font-medium items-center transition duration-200 shadow-md hover:shadow-lg"
