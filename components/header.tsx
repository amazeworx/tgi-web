...
function Header() {
  ...
  return (
    <div
      className={classNames('header bg-tgi-darkblue pt-0 fixed top-0 left-0 right-0 z-50', {
        'header-shrink': isShrunk,
      })}
    >
      <div className="header-top h-10 py-2 text-right px-8 flex justify-end gap-x-6">
      ...
      <div className="header-logo absolute top-0 left-12 z-10">
      ...
      <div className="header-bottom relative h-16 bg-gradient-to-t from-[#FFB245] via-[#FFC73C] to-[#FFE29B] border-y-2 border-[#FFC73C] shadow-md">
        <div className="header-bottom--inner pl-[256px] pr-8 h-full xl:pl-[220px] 3xl:pl-[256px]">
          <div className="flex h-full items-center justify-between">
            ...
            <div className="search-container relative hidden 3xl:block">
              <div className="pipe-screw absolute -top-3 -left-8 -translate-x-full -translate-y-2 w-5 h-20 bg-amber-400 rounded">
                <div className="absolute top-0 -left-1 flex items-center justify-center h-full w-1">
                  <div className="flex flex-col gap-y-2">
                    <div className="w-1.5 h-2 rounded-l bg-amber-500"></div>
                    <div className="w-1.5 h-2 rounded-l bg-amber-500"></div>
